							        ...
							        <div class="col-lg-2 col-sm-3 col-4 mb-3">
                                        <a href="<?= base_url("/siswa/cbt") ?>">
                                            <figure class="text-center">
                                                <img class="img-fluid"
                                                     src="<?= base_url() ?>/assets/app/img/ic_question.png" width="80"
                                                     height="80"/>
                                                <figcaption>TEST CBT</figcaption>
                                            </figure>
                                        </a>
									</div>
									<div class="col-lg-2 col-sm-3 col-4 mb-3">
                                        <a href="<?= base_url("/siswa/hasil") ?>">
                                            <figure class="text-center">
                                                <img class="img-fluid"
                                                     src="<?= base_url() ?>/assets/app/img/ic_certificate.png" width="80"
                                                     height="80"/>
                                                <figcaption>HASIL CBT</figcaption>
                                            </figure>
                                        </a>
									</div>
							</div>
