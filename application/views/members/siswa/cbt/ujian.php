            ...
            <div class="row mb-2">
                <div class="col-6">
                    <div class="info-box bg-transparent shadow-none">
                        <img src="<?= base_url() ?>/assets/img/favicon.png" width="60" height="60">
                        <div class="info-box-content">
                                <span class="text-white"
                                      style="font-size: 18pt; line-height: 0.7;"><b>BimaGarudaCBT</b></span>
                            <span class="text-white"><?= $setting->sekolah ?></span>
                        </div>
                    </div>
                </div>
                <div class="col-6">
